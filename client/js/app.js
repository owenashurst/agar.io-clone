...
function drawPlayer() {
    ...
    graph.arc(
        screenWidth / 2,
        screenHeight / 2,
        playerConfig.defaultSize + player.mass,
        0,
        2 * Math.PI
    );
    graph.stroke();
...
function drawEnemy(enemy) {
    ...
    graph.beginPath();
    graph.arc(
        enemy.x - player.x + screenWidth / 2,
        enemy.y - player.y + screenHeight / 2,
        enemyConfig.defaultSize + enemy.mass,
        0,
        2 * Math.PI
    );
    graph.fill();
